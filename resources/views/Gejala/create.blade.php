<x-app-layout>
    <div class="min-h-screen bg-white flex flex-col items-center justify-start py-10 px-4">
        ...
        <div class="w-full max-w-3xl bg-white border border-black rounded-md p-6 shadow-md">
            ...
            <p class="text-sm mb-4">Tolong isi data diri anak di bawah ini</p>
