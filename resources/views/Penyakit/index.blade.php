<x-app-layout>
    <div class="max-w-4xl mx-auto py-10 px-4">
        ...
        <div class="mb-6">
            <form action="{{ route('penyakit.store') }}" method="POST" class="bg-gray-100 p-4 rounded shadow space-y-4">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" name="disease_code" placeholder="Kode Penyakit (mis. P-01)" class="border p-2 rounded w-full" required>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2">
                                <div class="flex gap-3 items-center">
                                    <a href="{{ route('penyakit.edit', $disease->id) }}" class="text-blue-500 hover:underline">Edit</a>
                                    <x-danger-button
                                        x-data
                                        x-on:click.prevent="
